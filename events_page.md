...
**NOTE**: Comp shows the Promo Carousel active. If Promo Carousel is not active then Secondary Tiles 1 and 2 should appear the same as Secondary Tiles 3 and 4 in the Wireframe.
